...
def plot_likelihood_heatmap(likelihood_df, tau_start_for_plot):
    """
...
def plot_bayes_factor_heatmap(likelihood_df, tau_start_for_plot):
...
for language in languages:
    ...
    for model in models:
        ...
        plot_likelihood_heatmap(log_likelihood_df, tau_start_for_plot)