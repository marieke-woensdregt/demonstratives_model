...
for language in languages:
    ...
    if language == "English" or language == "Italian":
        ...
        print("max_likelihood_coordinates[0][0] are:")
        print(max_likelihood_coordinates[0][0])
        print("max_likelihood_coordinates[1][0] are:")
        print(max_likelihood_coordinates[1][0])
        print('')
